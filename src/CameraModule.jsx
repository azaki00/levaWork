...
const CameraModule = (props) => {
  ...
  const myMesh= useRef();
    ...
    const cameraPositions = [
      ...
      //   View1: { value: false, onChange: () => props.setView(1) },
      //   View2: { value: false, onChange: () => props.setView(2) },
      //   View3: { value: false, onChange: () => props.setView(3) },
      //   initialView:{value: false, onChange: () => props.setView(4)},
      //   finalView:{value: false, onChange: () => props.setView(5)}
      // })
      ...
      useFrame((state, delta) => {
        ...
        if (props.cameraView > 0 && props.cameraView <= cameraPositions.length ) {
          const newPosition = cameraPositions[props.cameraView - 1];
          const newTarget = targets[props.cameraView - 1];
